...
install_npm_packages "mkdocs_root/code/exampleapp/apps/api-flask" "$GS_BE_SCRIPTS"
...
install_npm_packages "mkdocs_root/code/exampleapp/apps/api-chalice" "$GS_BE_SCRIPTS"
...
install_npm_packages "mkdocs_root/code/exampleapp/apps/api-fastapi" "$GS_BE_SCRIPTS"

uninstal_npm_packages "mkdocs_root/code/exampleapp/apps/ui" "genericsuite genericsuite-ai"
install_npm_packages "mkdocs_root/code/exampleapp/apps/ui" "$GS_FE_CORE $GS_FE_AI $GS_FE_SCRIPTS"
...
install_npm_packages "mkdocs_root/code/fastapitemplate/server" "$GS_BE_SCRIPTS"

uninstal_npm_packages "mkdocs_root/code/fastapitemplate/ui" "genericsuite genericsuite-ai"
install_npm_packages "mkdocs_root/code/fastapitemplate/ui" "$GS_FE_CORE $GS_FE_AI $GS_FE_SCRIPTS"
