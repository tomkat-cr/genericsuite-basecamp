...
def assign_exampleapp_gpt_functions(
    ...
    _ = DEBUG and log_debug(
        'ASSIGN_EXAMPLEAPP_GPT_FUNCTIONS | Assigning ExampleApp GPT functions'
    )
...
def additional_gpt_func_appcontexts(
    ...
    _ = DEBUG and \
        log_debug('ADDITIONAL_GPT_FUNC_APPCONTEXTS | Assigning' +
                  ' ExampleApp additional GPT function AppContexts')
    ...
    if function_name == "get_fda_food_query":
        ...
        function_response = fuction_to_call(
            params={
                ...
                # "food_moment": function_args.get("food_moment"),
                "observations": function_args.get("observations"),
                "ingredients": function_args.get("ingredients"),
            }
        )
...
def get_additional_function_specs(
    ...
    Returns:
        ...
        ChatGPT functions.
    """
    _ = DEBUG and log_debug('GET_ADDITIONAL_FUNCTION_SPECS | ExampleApp' +
                            ' additional GPT function specs')
    _ = DEBUG and \
    ...
    result = [{
        ...
        "parameters": {
            ...
            "properties": {
                ...
                # "food_moment": {
                #     "type": "string",
                #     "description": "The name of the food moment" +
                #     " as registered in the food_moments table." +
                #     " (e.g., Lunch, Dinner, Mid-morning Snack," +
                #     " Mid-afternoon Snack, Breakfast," +
                #     " Mid-night snack, Other, Unassigned).",
                # },
                "observations": {
                    "type": "string",
