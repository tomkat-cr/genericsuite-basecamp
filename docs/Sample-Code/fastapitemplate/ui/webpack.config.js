...
const process_env = {
    ...
    REACT_APP_URI_PREFIX: JSON.stringify(process.env.REACT_APP_URI_PREFIX || 'fastapitemplate_ui'),
    REACT_APP_X_TOKEN: JSON.stringify(process.env.REACT_APP_X_TOKEN || ''),
    REACT_APP_APP_NAME: JSON.stringify(process.env.REACT_APP_APP_NAME || 'fastapitemplate'),
