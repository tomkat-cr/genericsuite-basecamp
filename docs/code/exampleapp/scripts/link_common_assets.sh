...
if [ "$ACTION" = "link" ]; then
    ...
    if [ "$COPY_OR_SYMLINK" = "symlink" ]; then
        ...
        link_common_assets "apps/api-fastapi/lib/config" "apps/api-chalice/lib"
        link_common_assets "apps/api-fastapi/lib/config" "apps/api-flask/lib"
        link_common_assets "apps/api-fastapi/lib/config" "apps/mcp-server/lib"

        link_common_assets "apps/api-fastapi/lib/models" "apps/api-chalice/lib"
        link_common_assets "apps/api-fastapi/lib/models" "apps/api-flask/lib"
        link_common_assets "apps/api-fastapi/lib/models" "apps/mcp-server/lib"

        link_common_assets "apps/api-fastapi/scripts" "apps/api-chalice"
        link_common_assets "apps/api-fastapi/scripts" "apps/api-flask"
        link_common_assets "apps/api-fastapi/scripts" "apps/mcp-server"
    else
        ...
        copy_common_assets "apps/api-fastapi/lib/config" "apps/api-chalice/lib/"
        copy_common_assets "apps/api-fastapi/lib/config" "apps/api-flask/lib/"
        copy_common_assets "apps/api-fastapi/lib/config" "apps/mcp-server/lib/"

        copy_common_assets "apps/api-fastapi/lib/models" "apps/api-chalice/lib/"
        copy_common_assets "apps/api-fastapi/lib/models" "apps/api-flask/lib/"
        copy_common_assets "apps/api-fastapi/lib/models" "apps/mcp-server/lib/"

        copy_common_assets "apps/api-fastapi/scripts" "apps/api-chalice/"
        copy_common_assets "apps/api-fastapi/scripts" "apps/api-flask/"
        copy_common_assets "apps/api-fastapi/scripts" "apps/mcp-server/"
    fi
    exit 0
fi
