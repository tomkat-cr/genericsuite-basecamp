...
export default defineConfig(({ mode }) => {
    ...
    const process_env = {
        ...
        REACT_APP_API_URL: (process.env.REACT_APP_API_URL_FOR_BUILD || process.env.REACT_APP_API_URL || `https://${appLocalDomainName}`),
        REACT_APP_DEBUG: (process.env.REACT_APP_DEBUG || '0'),
        REACT_APP_URI_PREFIX: (process.env.REACT_APP_URI_PREFIX || 'fastapitemplate_ui'),
        REACT_APP_X_TOKEN: (process.env.REACT_APP_X_TOKEN || ''),
        REACT_APP_APP_NAME: (process.env.REACT_APP_APP_NAME || 'fastapitemplate'),
    ...
    console.log('');
    console.log('process.env.REACT_APP_API_URL_FOR_BUILD', process.env.REACT_APP_API_URL_FOR_BUILD);
    console.log('');
