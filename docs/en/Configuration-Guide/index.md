...
Click [here](../../code/exampleapp/README.md) to know more about it.
...
* [backend/users_api_keys.json](../../code/genericsuite-configs/backend/users_api_keys.json), where the `table_name` is "users_api_keys" defining the related table physical table name in the database
...
* [backend/users_config.json](../../code/genericsuite-configs/backend/users_config.json), where the `table_name` is "users" defining the parent table physical table name in the database
