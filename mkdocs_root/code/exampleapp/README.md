...
You can view the [Source Code here](https://github.com/tomkat-cr/genericsuite-basecamp/tree/main/mkdocs_root/code/exampleapp).
...
```bash
cp -r genericsuite-basecamp/mkdocs_root/code/exampleapp ~/dev/myapp
```
...
The `exampleapp` directory is located in the Basecamp `mkdocs_root/code/exampleapp` directory. It contains the following structure:
```
exampleapp/
├── apps/
