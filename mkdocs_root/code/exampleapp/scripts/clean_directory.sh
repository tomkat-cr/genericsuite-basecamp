#!/bin/bash
# clean_directory.sh
# Clean up all `node_modules`, `dist`, `build`, `.env*`, `.turbo`, `logs` directories under `mkdocs_root/code/exampleapp` (or ./site) and sub-directories.
# 2025-07-05 | CR
...
show_help() {
    ...
    echo ""
    echo "Example:"
    echo "clean_directory.sh ./mkdocs_root/code/exampleapp true true"
    echo ""
    exit 1
}
